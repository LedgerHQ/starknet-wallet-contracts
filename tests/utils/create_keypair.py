...
def create_keypair(n_keys: int):
    ...
    privkeys= [2523845276430757028405734299752039490663013462432225089608404049947463046225, 1576448449201733381605048531123859424271649298253787562369801966884966169831]
    # Generate n keys
    for i in range(0, n_keys):
        # privkey = os.urandom(32)
        privkey_int = privkeys[i]
