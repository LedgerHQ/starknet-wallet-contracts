...
G = (0x1ef15c18599971b7beced415a40f0c7deacfd9b0d1819e03d723d8bc943cfca,
...
# after hashing tag_hash instead of rehashing it all the time
# Get the hash digest of (tag_hashed || tag_hashed || message)
def tagged_perderson_hash(tag: str, msg: bytes) -> bytes:
    tag_hash = pedersen_hash(tag.encode()).digest()
    return pedersen_hash(tag_hash + tag_hash + msg).digest()
