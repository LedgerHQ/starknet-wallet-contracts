...
from utils.schnorr_lib import sha256, schnorr_sign, schnorr_musig_sign, schnorr_musig2_sign
import eth_keys
...
class SchnorrMockSigner():
    """
    Utility for sending signed transactions to an Account on Starknet using schnorrSignature.
